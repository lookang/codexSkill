...
[`interactive-xapi-designer`](plugins/interactive-xapi-designer/) turns a learning goal or existing interactive into an accessible SLS-ready package in one pass, with verified scoring, misconception analytics, and a visual teacher report. It uses the [SLS Prompt Generator and Interactive Prompt Library](https://iwant2study.org/lookangejss/promptLibrary/ai-prompt-library.html) together with the [SLS xAPI Integrator Agent](https://iwant2study.org/lookangejss/appXapiIntegratorAgent/public/) as the maintained basis for its workflow.
